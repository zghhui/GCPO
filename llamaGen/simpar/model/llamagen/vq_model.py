...
class VQModel(nn.Module):
    ...
    def decode_code(self, code_b, shape=None, channel_first=True):
        quant_b, z_q_embedding = self.quantize.get_codebook_entry(code_b, shape, channel_first)
        dec = self.decode(quant_b)
        return z_q_embedding, dec
