...
class LlamaModel(LlamaPreTrainedModel):
    ...
    def forward(
        ...
        # with open("/home/supervisor/data/ZYZ/zgh/AIGC/AR/SimpleAR_LLamaGen_v2/ref_per_token_logps.txt", "a") as f:
        #     import numpy as np
        #     f.write('new epoch')
        for idx, decoder_layer in enumerate(self.layers):
            ...
            # with open("/home/supervisor/data/ZYZ/zgh/AIGC/AR/SimpleAR_LLamaGen_v2/ref_per_token_logps.txt", "a") as f:
            #     import numpy as np
            #     f.write(np.array_str(hidden_states.to(torch.float32).cpu().numpy()))
            # if ff == 1:
            #     with open("/home/supervisor/data/ZYZ/zgh/AIGC/AR/SimpleAR_LLamaGen_v2/ref_per_token_logps.txt", "a") as f:
            #         import numpy as np
            #         f.write(np.array_str(hidden_states.to(torch.float32).cpu().numpy()))
